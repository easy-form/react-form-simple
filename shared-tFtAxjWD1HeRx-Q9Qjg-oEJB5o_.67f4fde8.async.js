...
`;function Gt(e,n,i){switch(i){case"bottom-left":return n?an:Ve;case"bottom-right":return n?cn:Je;case"down":return e?n?Ht:se:n?An:Ze;case"left":return e?n?a:Ie:n?ln:Yt;case"right":return e?n?v:Se:n?m:qe;case"top-left":return n?R:Pt;case"top-right":return n?q:t;case"up":return e?n?St:c:n?gt:r;default:return n?ye:Be}}const ft=e=>{const b=e,{big:n=!1,direction:i,reverse:A=!1}=b,p=Bt(b,["big","direction","reverse"]),C=useMemo(()=>Gt(n,A,i),[n,i,A]);return jsx(P,nt({keyframes:C},p))},pt=(0,o.F4)`
  from {
